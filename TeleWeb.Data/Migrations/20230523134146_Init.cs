        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Channels_Users_PrimaryAdminId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChannelAdmin", x => new { x.AdminId, x.ChannelId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserChannelSubscription", x => new { x.UserId, x.ChannelId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Channels_PrimaryAdminId",
                table: "Channels",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Posts_AdminWhoPostedId",
                table: "Posts",
                column: "AdminWhoPostedId");
